...
public class History {
         ...
         * Default values:
         */
    String url = "https://nfsvn.foresee.com.cn/svn/GT3-NF-QGTGB/trunk/engineering/src";
    String name = "leidexiang";
    String password = "leidexiang";
    long startRevision = 16746;
	...
	public void showHistory(){
        ...
        SVNRepository repository = createSVNRepo();
        ...
        //showLog(logEntries);
        System.out.println(getLogPathList(logEntries));
    }
	
	public List<SvnResource> getLogPathList(Collection<SVNLogEntry> logEntries){
	...
	private void showLog(Collection<SVNLogEntry> logEntries){
	...
	private SVNRepository createSVNRepo(){
	...
	public static void main(String[] args) {
	    ...
	    if (args != null) {
	         ...
	         */
	    	hist.url = (args.length >= 1) ? args[0] : hist.url;
	        /*
	         * Obtains the start point of the revisions range
	         */
	    	hist.startRevision = (args.length >= 2) ? Long.parseLong(args[1])
	                : hist.startRevision;
	        /*
	         * Obtains the end point of the revisions range
	         */
	    	hist.endRevision = (args.length >= 3) ? Long.parseLong(args[2])
	                : hist.endRevision;
	        /*
	         * Obtains an account name (will be used to authenticate the user to
	         * the server)
	         */
	    	hist.name = (args.length >= 4) ? args[3] : hist.name;
	        /*
	         * Obtains a password
	         */
	    	hist.password = (args.length >= 5) ? args[4] : hist.password;
	    }
