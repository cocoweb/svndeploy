    ...
    class DiffHandler implements ISVNDiffStatusHandler {
        ...
        public void handleDiffStatus(SVNDiffStatus diffStatus) throws SVNException {
            ...
            if (diffStatus.getKind() == SVNNodeKind.FILE
                    && (diffStatus.getModificationType() == SVNStatusType.STATUS_ADDED || diffStatus
        ...
        public String statusToString(SVNDiffStatus diffStatus) {
            return PathUtils.autoPathRoot(diffStatus.getPath(),svnDiffKeyroot); // () +diffStatus.getURL().toString();
    
        }

    }

    public ArrayList<String> svnDiff(String xUrl, String startVersion, String endVersion, String svndiffkeyroot) throws SVNException {
