...
public class ScanIncrementFiles {
    ...
    private String handleProjectName(String xname){
        //xname = xname.replaceAll( "[\\p{P}+~$`^=|<>～｀＄＾＋＝｜＜＞￥×^_]" , ",");  //StringUtil.replaceAll(xname,"、",",");
...
//            return "/"+str;
    ...
    public static List<ArrayList<String>> scanListfile(String excelfile,String excelFolder,String scanOption,String xfilter){
        ScanIncrementFiles xx = new ScanIncrementFiles(excelfile, excelFolder, scanOption);
        return xx.loadExcelFiles(xfilter);
    }
...
//            retList.addAll(loadExcelFile(xfile));
    ...
    {
        ScanIncrementFiles xx= new ScanIncrementFiles("p:/因开发所致环境变更记录表模版-20150820-产品线-合并.xls",
        		"P:\\workspace\\xls",BATCH);
